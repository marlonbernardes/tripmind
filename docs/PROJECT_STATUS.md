...
- [ ] Increase font size in desktop (keep UI condensed, but slightly bigger font)
- [ ] we need a line separating rows (if that doesnt work, alternating bg colors)
- [ ] Move "AI assistant" box to tab similar to the details/recommend ones
