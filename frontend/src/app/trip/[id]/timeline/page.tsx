...
export default function TimelinePage({ params }: TimelinePageProps) {
  ...
  const [currentView, setCurrentView] = useState<'timeline' | 'gantt' | 'map'>('timeline') // Default to Timeline view
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      <div>
                        ...
                        <div className="font-medium text-gray-900 dark:text-white capitalize mt-1">{selectedActivity.type}</div>
                      </div>
                      <div>
                    ...
                    {selectedActivity.city && (
                      <div className="text-sm">
                        ...
                        <div className="font-medium text-gray-900 dark:text-white mt-1">{selectedActivity.city}</div>
                      </div>
                    )}
                  </div>
                </div>
